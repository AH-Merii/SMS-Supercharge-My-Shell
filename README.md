...
commands and builtins, for a function only when its source handles the flag, in colour where
the tool offers it. Nothing is documented by hand except the key bindings: abbreviations carry
